...
const TwoModals: React.FC<Props> = props => {
    ...
    return (
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginBottom: hp('1%') }}>
            ...
            >
                <View style={GlobalStyles.ModalContainer}>
                    <View style={GlobalStyles.ModalView}>
                        <Text style={[GlobalStyles.smallText, { marginBottom: hp('2%') }]}>{props.firstModalTitle}</Text>
            ...
            <Pressable style={styles.studentSelector} onPress={() => setFirstModalVisibility(true)}>
            ...
            >
                <View style={GlobalStyles.ModalContainer}>
                    <View style={GlobalStyles.ModalView}>
                        <Text style={[GlobalStyles.smallText, { marginBottom: hp('2%') }]}>{props.secondModalTitle}</Text>
                        <ScrollView style={{ flexGrow: 1, }}>
            ...
            <Pressable style={styles.studentSelector} onPress={() => setSecondModalVisibility(true)}>
